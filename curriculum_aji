...
create table curriculum.section_detail(
	...
	secd_sect_id int,
	foreign key(secd_sect_id)references curriculum.program_entity(prog_entity_id)
)
...
create table curriculum.section_detail_material(
	...
	sedm_secd_id int,
	foreign key(sedm_secd_id)references curriculum.program_entity(prog_entity_id)
)
